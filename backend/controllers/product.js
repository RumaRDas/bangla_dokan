 ...
 * other product that has been same category, will be retuened
 */
  ...
  for (let key in req.body.filters) {
    if (req.body.filters[key].length > 0) {
      if (key === "price") {
        ...
        // lte - less than
        findArgs[key] = {
          $gte: req.body.filters[key][0], //grater then 0 price
          $lte: req.body.filters[key][1], //less then one price
        };
      } else {
...
exports.listSearch = (req, res) => {
  ...
  // essign search value to query.name
  if (req.query.search) {
    query.name = { $regex: req.query.search, $options: "i" };
    //assign category value to query.category
    if (req.query.category && req.puery.category != "All") {
